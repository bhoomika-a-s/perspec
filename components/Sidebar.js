...
import logo from '../assets/spot-it.png'
import logoFull from '../assets/spot-it.png'
import Image from 'next/image'
import { FaBox } from 'react-icons/fa'
import { BsFillBookmarkFill } from 'react-icons/bs'
import { BsFillPersonFill } from 'react-icons/bs'
import { SpotitContext } from '../context/SpotitContext'
...
const Sidebar = () => {
  const styles = {
    ...
    SpotitLogo: `mr-4 flex object-cover`,
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.companyName}>
        <Image src={logoFull} alt='Spotit' height={100} width={100} />
      </div>
    </div>
  )
}
